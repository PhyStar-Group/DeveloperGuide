...
\subsection{Saffman 升力}
 Saffman 升力$\ve F^d=6\pi \mu R (\ve u-\ve v)(1+0.15Re_p^{0.687})$,\\\qquad\qquad$\ve F^{Saff}=1.615J\mu2R|\Delta \ve u|\sqrt{\frac{4R^2|\ve \Omega|}{\nu}}\frac{\ve \Omega\times\Delta \ve u}{|\ve \Omega||\Delta \ve u|}$, 其中$\Delta \ve u=\ve v-\ve u$
\begin{itemize}
